...
import { getDefaultRect, konvaNodeToBlob, previewBlob } from 'features/controlLayers/konva/util';
...
export class CanvasLayer {
  ...
  calculateBbox = debounce(() => {
    ...
    if (!this.renderer.hasObjects()) {
      ...
      this.rect = getDefaultRect();
      this.bbox = getDefaultRect();
